...
public enum MimeType: String {
	...
	case cpt = "image/x-corelphotopaint"
	...
	case sdp = "application/vnd.stardivision.impress"
	...
	case val = "chemical/x-ncbi-asn1-binary"
	...
	case mmd = "chemical/x-macromodel-input"
	...
	case com = "application/x-msdos-program"
	case msi = "application/x-msi"
	case mvb = "chemical/x-mopac-vib"
	...
	case inp = "chemical/x-gamess-input"
	...
	case css = "text/css"
	case csv = "text/comma-separated-values"
	case html = "text/html"
	case n3 = "text/n3"
	case dsc = "text/prs.lines.tag"
	case sgml = "text/sgml"
	case tsv = "text/tab-separated-values"
	case t = "application/x-troff"
	...
	case _3gpp = "video/3gpp"
	case _3gpp2 = "video/3gpp2"
	...
	case anx = "application/annodex"
	case atomsrv = "application/atomserv+xml"
	case lin = "application/bbolin"
	case dcm = "application/dicom"
	case tsp = "application/dsptype"
	case gz = "application/gzip"
	case hta = "application/hta"
	case m3g = "application/m3g"
	case key = "application/pgp-keys"
	case sfd = "application/vnd.font-fontforge-sfd"
	case sds = "application/vnd.stardivision.chart"
	case sd = "chemical/x-mdl-sdfile"
	case wp5 = "application/vnd.wordperfect5.1"
	case wk = "application/x-123"
	case mph = "application/x-comsol"
	case mm = "application/x-freemind"
	case gan = "application/x-ganttproject"
	case sgf = "application/x-go-sgf"
	case gcf = "application/x-graphing-calculator"
	case tgz = "application/x-gtar-compressed"
	case hwp = "application/x-hwp"
	case ica = "application/x-ica"
	case info = "application/x-info"
	case ins = "application/x-internet-signup"
	case iii = "application/x-iphone"
	case jmz = "application/x-jmol"
	case kil = "application/x-killustrator"
	case lyx = "application/x-lyx"
	case lzx = "application/x-lzx"
	case manifest = "application/x-ms-manifest"
	case pac = "application/x-ns-proxy-autoconfig"
	case nwc = "application/x-nwc"
	case o = "application/x-object"
	case oza = "application/x-oz-application"
	case pyc = "application/x-python-code"
	case qgs = "application/x-qgis"
	case qtl = "application/x-quicktimeplayer"
	case rdp = "application/x-rdp"
	case rpm = "application/x-redhat-package-manager"
	case rb = "application/x-ruby"
	case sci = "application/x-scilab"
	case xcos = "application/x-scilab-xcos"
	case scr = "application/x-silverlight"
	case gf = "application/x-tex-gf"
	case pk = "application/x-tex-pk"
	case trash = "application/x-trash"
	case wz = "application/x-wingz"
	case xcf = "application/x-xcf"
	case amr = "audio/amr"
	case awb = "audio/amr-wb"
	case axa = "audio/annodex"
	case csd = "audio/csound"
	case gsm = "audio/x-gsm"
	case sd2 = "audio/x-sd2"
	case alc = "chemical/x-alchemy"
	case cac = "chemical/x-cache"
	case csf = "chemical/x-cache-csf"
	case cbin = "chemical/x-cactvs-binary"
	case c3d = "chemical/x-chem3d"
	case cpa = "chemical/x-compass"
	case bsd = "chemical/x-crossfire"
	case ctx = "chemical/x-ctx"
	case cxf = "chemical/x-cxf"
	case emb = "chemical/x-embl-dl-nucleotide"
	case fch = "chemical/x-gaussian-checkpoint"
	case cub = "chemical/x-gaussian-cube"
	case gau = "chemical/x-gaussian-input"
	case gal = "chemical/x-gaussian-log"
	case gcg = "chemical/x-gcg8-sequence"
	case gen = "chemical/x-genbank"
	case hin = "chemical/x-hin"
	case istr = "chemical/x-isostar"
	case jdx = "chemical/x-jcamp-dx"
	case kin = "chemical/x-kinemage"
	case mcm = "chemical/x-macmolecule"
	case mol = "chemical/x-mdl-molfile"
	case rd = "chemical/x-mdl-rdfile"
	case rxn = "chemical/x-mdl-rxnfile"
	case tgf = "chemical/x-mdl-tgf"
	case mcif = "chemical/x-mmcif"
	case mol2 = "chemical/x-mol2"
	case b = "chemical/x-molconn-z"
	case gpt = "chemical/x-mopac-graph"
	case moo = "chemical/x-mopac-out"
	case asn = "chemical/x-ncbi-asn1-spec"
	case prt = "chemical/x-ncbi-asn1-ascii"
	case ros = "chemical/x-rosdal"
	case sw = "chemical/x-swissprot"
	case vms = "chemical/x-vamas-iso14976"
	case vmd = "chemical/x-vmd"
	case xtel = "chemical/x-xtel"
	case jp2 = "image/jp2"
	case jpx = "image/jpx"
	case cr2 = "image/x-canon-cr2"
	case crw = "image/x-canon-crw"
	case cdr = "image/x-coreldraw"
	case pat = "image/x-coreldrawpattern"
	case cdt = "image/x-coreldrawtemplate"
	case erf = "image/x-epson-erf"
	case art = "image/x-jg"
	...
	case tm = "text/texmacs"
	case bib = "text/x-bibtex"
	case boo = "text/x-boo"
	case htc = "text/x-component"
	case d = "text/x-dsrc"
	case diff = "text/x-diff"
	case hs = "text/x-haskell"
	case ly = "text/x-lilypond"
	case lhs = "text/x-literate-haskell"
	case moc = "text/x-moc"
	case gcd = "text/x-pcs-gcd"
	case pl = "text/x-perl"
	case py = "text/x-python"
	case scala = "text/x-scala"
	case axv = "video/annodex"
	case dl = "video/dl"
	case dif = "video/dv"
	case gl = "video/gl"
	case ts = "video/mp2ts"
	case lsf = "video/x-la-asf"
	case yt = "application/vnd.youtube.yt"
	case fl = "application/x-android-drm-fl"
	case pem = "application/x-pem-file"
	case webarchive = "application/x-webarchive"
	case webarchivexml = "application/x-webarchive-xml"
	case imy = "audio/imelody"
	case mxmf = "audio/mobile-xmf"
	case heic = "image/heic"
	case heics = "image/heic-sequence"
	case heif = "image/heif"
	case heifs = "image/heif-sequence"
	case cur = "image/ico"
	case dng = "image/x-adobe-dng"
	case raf = "image/x-fuji-raf"
	case nrw = "image/x-nikon-nrw"
	case rw2 = "image/x-panasonic-rw2"
	case pef = "image/x-pentax-pef"
	case srw = "image/x-samsung-srw"
	case arw = "image/x-sony-arw"
	case phps = "text/text"
	case wrf = "video/x-webex"
}